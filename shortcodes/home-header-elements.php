...
add_action('init', 'quad_home_header_init', 99 );
function quad_home_header_init(){


    global $kc;
    $kc->add_map(
        array(
            'quad_home_header' => array(
                'name' => 'Home Header',
...
function render_quad_home_header($atts, $content = null){
...
add_shortcode('quad_home_header', 'render_quad_home_header');
